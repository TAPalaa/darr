...
const CategoryArabicPage = () => {
  ...
  return (
    ...
    <div className="framer-1a032it featured-publications">
      <h1 className="framer-text" lang="ar">اللغة العربية</h1>
    </div>
    <div className="page-description" style={{ textAlign: 'center', marginBottom: '40px' }}>
      <p lang="ar" style={{ fontSize: '1.2rem', lineHeight: '1.8', color: 'var(--text-medium)' }}>
        كتب تعليم اللغة العربية وقواعدها وآدابها للطلاب والمهتمين
      </p>
    </div>
            ...
            <div className="category-banner" style={{ 
              ...
              <div style={{ 
                ...
                <p lang="ar" style={{ 
                  ...
                  اللغة العربية من احد العلوم الدينية
                </p>
              </div>
            </div>
...
export default CategoryArabicPage;