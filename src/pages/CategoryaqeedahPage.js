...
const CategoryaqeedahPage = () => {
  ...
  return (
    <div className="au-page-container">
      ...
      <h1 className="framer-text" lang="ar">العقيدة الإسلامية</h1>
    </div>
    <div className="page-description" style={{ textAlign: 'center', marginBottom: '40px' }}>
      <p lang="ar" style={{ fontSize: '1.2rem', lineHeight: '1.8', color: 'var(--text-medium)' }}>
        كتب العقيدة الإسلامية وأصول الدين وفق المذاهب المعتمدة
      </p>
    </div>
...
export default CategoryaqeedahPage;