...
const CategoryislamicPage = () => {
  ...
  return (
    <div className="au-page-container">
      ...
      <h1 className="framer-text" lang="ar">العلوم الإسلامية</h1>
    </div>
    <div className="page-description" style={{ textAlign: 'center', marginBottom: '40px' }}>
      <p lang="ar" style={{ fontSize: '1.2rem', lineHeight: '1.8', color: 'var(--text-medium)' }}>
        كتب متنوعة في مختلف العلوم الإسلامية والمعارف الدينية
      </p>
    </div>
            ...
            <div className="category-banner" style={{ 
              ...
              <div style={{ 
                ...
                <p lang="ar" style={{ 
                  ...
                  الاسلاميات من احد العلوم الدينية
                </p>
              </div>
            </div>
...
export default CategoryislamicPage;