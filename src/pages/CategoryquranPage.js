  ...
  return (
    <div className="au-page-container">
     {/* del Content */}
      ...
      <h1 className="framer-text" lang="ar">علوم القرآن الكريم</h1>
    </div>
    <div className="page-description" style={{ textAlign: 'center', marginBottom: '40px' }}>
      <p lang="ar" style={{ fontSize: '1.2rem', lineHeight: '1.8', color: 'var(--text-medium)' }}>
        كتب تفسير القرآن وعلومه وإعجازه وأحكام التلاوة
      </p>
    </div>
            ...
            <div className="category-banner" style={{ 
              ...
              <div style={{ 
                ...
                <p lang="ar" style={{ 
                  ...
                  علوم القران من احد العلوم الدينية
                </p>
              </div>
            </div>
...
export default CategoryquranPage;